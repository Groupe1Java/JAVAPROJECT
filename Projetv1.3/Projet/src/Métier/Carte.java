...
public class Carte {
	...
	public static void ModifCarte(int id, String nom, String description, String image, String lien, String libelle, java.util.Date ajd) throws SQLException {
		// TODO Auto-generated method stub
...
/********************Pour les news**********************/
	...
	{
	String chainereq ="UPDATE carte SET  date_crea_carte=?";
	...
	public static void SupprUneNews(int idNews)
	{
	   ...
	   String chainereq ="UPDATE carte SET  date_crea_carte=? WHERE id_carte = ?;";
